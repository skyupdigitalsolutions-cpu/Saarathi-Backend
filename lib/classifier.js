...
function leadToText(lead) {
  ...
  // Append raw Meta form Q&A when structured fields are thin — gives AI full context
  if (lead.metaFormAnswers?.length > 0) {
    lines.push("", "Raw form answers:");
    for (const qa of lead.metaFormAnswers) {
